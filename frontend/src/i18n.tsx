...
const en: Dict = {
  ...
  "nav.pts": "pts",
  "nav.connect_slot": "Connect a slot",
  "nav.connect_slot.none": "No other slots to connect.",
  "nav.connect_slot.hint": "Same room password: no re-entry needed.",
  "nav.disconnect_slot": "Disconnect {slot}",
  ...
  "dash.bked.kicker": "Blocked",
  "dash.bked.title": "BKed checks",
  "dash.bked.intro": "BKed checks that involve you: items you're waiting on, and checks in your world that unblock someone else.",
  "dash.bked.finder": "in {finder}'s world",
  "dash.bked.for_receiver": "in your world · unblocks {receiver}",
  ...
  "slot.tab.received": "Received",
  "slot.search_received": "Search received items…",
  ...
  "hints.banner.cost": "Each hint costs",
  "hints.banner.balance": "you have",
  "hints.banner.afford": "You can afford {n} more hint{plural} right now",
  ...
  "hints.col.tag": "Tag",
  "hints.tag.bked": "BKed 🍔",
  "hints.tag.mandatory": "Mandatory",
  "hints.tag.comfort": "Comfort",
  "hints.tag.none": "No tag",
  "hints.tag.set": "Set tag",
  ...
  "hints.toggle.sort_tag": "Sort by tag",
  "hints.toggle.sort_slot": "Sort by slot",
  "hints.slotfilter.all": "All mine",
  ...
  "tracker.signin_title": "Sign in to use the tracker",
  "tracker.signin_body": "The tracker runs against your own slot's logic, so you need to be logged in as that slot.",
  "tracker.intro": "Runs the real Universal Tracker against your slot to see which remaining locations are currently reachable.",
  "tracker.yaml.missing_title": "Upload your YAML first",
  "tracker.yaml.missing_body": "The tracker needs the same options YAML you used to generate this slot to recompute its logic.",
  "tracker.yaml.button": "Upload YAML",
  "tracker.yaml.uploading": "Uploading…",
  "tracker.yaml.uploaded": "YAML on file for this slot.",
  "tracker.yaml.dropzone.idle": "Drag and drop your YAML here, or click to browse",
  "tracker.yaml.dropzone.active": "Drop it",
  "tracker.yaml.dropzone.hint": ".yaml or .yml",
  "tracker.yaml.wrong_type": "That's not a .yaml or .yml file.",
  "tracker.yaml.remove": "Remove selected file",
  "tracker.run.button": "Run tracker",
  "tracker.run.running": "Running tracker… this can take up to a minute.",
  "tracker.run.rerun": "Run again",
  "tracker.stat.total": "total",
  "tracker.stat.checked": "checked",
  "tracker.stat.remaining": "remaining",
  "tracker.stat.accessible": "accessible",
  "tracker.search": "Search locations…",
  "tracker.list.accessible": "Accessible",
  "tracker.list.not_accessible": "Not yet",
  "tracker.empty": "No remaining locations.",
  "tracker.disabled_title": "Tracker disabled",
  "tracker.disabled_body": "This dashboard's tracker is disabled. Set [tracker].enabled = true (and a launcher path) in config.toml to use it.",
  "tracker.error.default": "Something went wrong running the tracker.",
...
const fr: Dict = {
  ...
  "nav.slot": "joueur",
  "nav.pts": "pts",
  "nav.connect_slot": "Connecter un slot",
  "nav.connect_slot.none": "Aucun autre slot à connecter.",
  "nav.connect_slot.hint": "Même mot de passe de salle : aucune ressaisie nécessaire.",
  "nav.disconnect_slot": "Déconnecter {slot}",
  ...
  "dash.bked.kicker": "Bloqué",
  "dash.bked.title": "Checks BKed",
  "dash.bked.intro": "Les checks BKed qui vous concernent: ce que vous attendez, et les checks dans votre monde qui débloquent quelqu'un.",
  "dash.bked.finder": "dans le monde de {finder}",
  "dash.bked.for_receiver": "dans votre monde · débloque {receiver}",
  ...
  "slot.tab.received": "Reçus",
  "slot.search_received": "Chercher un objet reçu…",
  ...
  "hints.banner.cost": "Chaque indice coûte",
  "hints.banner.balance": "vous avez",
  "hints.banner.afford": "Vous pouvez vous offrir {n} indice{plural} de plus",
  ...
  "hints.tag.none": "Sans étiquette",
  "hints.tag.set": "Définir l'étiquette",
  ...
  "hints.toggle.sort_slot": "Trier par slot",
  "hints.slotfilter.all": "Tous les miens",
  ...
  "tracker.kicker": "Tracker",
  "tracker.title": "Universal Tracker",
  "tracker.signin_title": "Connectez-vous pour utiliser le tracker",
  "tracker.signin_body": "Le tracker s'exécute sur la logique de votre propre slot, vous devez donc être connecté avec ce slot.",
  "tracker.intro": "Exécute l'Universal Tracker sur votre slot pour voir quels emplacements restants sont actuellement accessibles.",
  "tracker.yaml.missing_title": "Envoyez d'abord votre YAML",
  "tracker.yaml.missing_body": "Le tracker a besoin du même fichier d'options YAML utilisé pour générer ce slot afin de recalculer sa logique.",
  "tracker.yaml.button": "Envoyer le YAML",
  "tracker.yaml.uploading": "Envoi…",
  "tracker.yaml.uploaded": "YAML enregistré pour ce slot.",
  "tracker.yaml.dropzone.idle": "Glissez votre YAML ici, ou cliquez pour parcourir",
  "tracker.yaml.dropzone.active": "Déposez-le",
  "tracker.yaml.dropzone.hint": ".yaml ou .yml",
  "tracker.yaml.wrong_type": "Ce n'est pas un fichier .yaml ou .yml.",
  "tracker.yaml.remove": "Retirer le fichier sélectionné",
  "tracker.run.button": "Lancer le tracker",
  "tracker.run.running": "Le tracker s'exécute… cela peut prendre jusqu'à une minute.",
  "tracker.run.rerun": "Relancer",
  "tracker.stat.total": "total",
  "tracker.stat.checked": "validés",
  "tracker.stat.remaining": "restants",
  "tracker.stat.accessible": "accessibles",
  "tracker.search": "Chercher un emplacement…",
  "tracker.list.accessible": "Accessible",
  "tracker.list.not_accessible": "Pas encore",
  "tracker.empty": "Aucun emplacement restant.",
  "tracker.disabled_title": "Tracker désactivé",
  "tracker.disabled_body": "Le tracker de ce tableau de bord est désactivé. Réglez [tracker].enabled = true (et un chemin de lanceur) dans config.toml pour l'utiliser.",
  "tracker.error.default": "Une erreur est survenue pendant l'exécution du tracker.",
