...
const en: Dict = {
  ...
  "slot.hint_pts_estimated_note": "Estimated: accurate only if every hint for this room is requested from this dashboard.",
  "slot.hints": "hints",
...
const fr: Dict = {
  ...
  "slot.hint_pts_estimated_note": "Estimation : fiable seulement si tous les indices de cette room sont demandés depuis ce dashboard.",
  "slot.hints": "indices",
